...
import wng.util.TrustAllSSLProvider;
...
public class DesktopApplication extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        webEngine.setUserDataDirectory(Wng.getConfDir());
        ...
        loadWorker.stateProperty().addListener(
                (ov, oldState, newState) -> {
                    ...
                    stage.setTitle("WNG Desktop - " + webEngine.getLocation());
                    if (newState == Worker.State.SUCCEEDED) {
                        ...
                        Wng.getTransactionProcessor().addListener((transaction) ->
        ...
        stage.getIcons().add(new Image(address + "/img/wng-icon-32x32.png"));
    ...
    private static String getUrl() {
        ...
        String defaultAccount = Wng.getStringProperty("wng.defaultDesktopAccount");
